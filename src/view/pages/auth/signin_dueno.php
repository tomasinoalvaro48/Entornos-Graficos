    ...
    <section class="c-card" aria-label="Registro de dueño">
      ...
      <form action="../../../controller/handle_signin.php" method="post" id="formSigninDueno" class="c-form-layout">
        ...
        <div class="c-form-field" style="position: relative;">
          <input class="c-form-input" type="password" name="clave_dueno" id="pass_dueno" placeholder=" " autocomplete="new-password" required style="padding-right: 2.5rem;" />
          <label class="c-form-label" for="pass_dueno">Contraseña</label>
          <button type="button" onclick="togglePasswordVisibility('pass_dueno', this)" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer; color: #6c757d; padding: 0;">
        ...
        <div class="c-form-field" style="position: relative;">
          <input class="c-form-input" type="password" name="clave_dueno_conf" id="pass_dueno_conf" placeholder=" " autocomplete="new-password" required style="padding-right: 2.5rem;" />
          <label class="c-form-label" for="pass_dueno_conf">Repetir contraseña</label>
          <button type="button" onclick="togglePasswordVisibility('pass_dueno_conf', this)" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer; color: #6c757d; padding: 0;">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
              <path d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8zM1.173 8a13.133 13.133 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5c2.12 0 3.879 1.168 5.168 2.457A13.133 13.133 0 0 1 14.828 8c-.058.087-.122.183-.195.288-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5c-2.12 0-3.879-1.168-5.168-2.457A13.134 13.134 0 0 1 1.172 8z"/>
              <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0z"/>
            </svg>
...
<script>
  ...
  const passInputId = 'pass_dueno';
  const passConfInputId = 'pass_dueno_conf';
